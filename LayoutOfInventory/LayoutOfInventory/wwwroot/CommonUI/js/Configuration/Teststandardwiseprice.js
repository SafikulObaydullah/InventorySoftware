   ...
   $("#gridTable").kendoGrid({
      ...
      columns: [
...

         {
            ...
            field: "testStandardWiseName", width: 80,
            attributes: {
...
function Validate() {
   ...
   if ($('#RegularPrice').val() == "") {
      $('#RegularPrice').focus();
      toastr.warning('Please input RegularPrice',"Warning");
      return false;
   }
   if ($('#ExpressPrice').val() == "") {
      $('#ExpressPrice').focus();
      toastr.warning('Please input ExpressPrice', "Warning");
      return false;
   }
